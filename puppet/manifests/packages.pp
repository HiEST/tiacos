...
package { ['curl', 'unzip', 'vim', 'make', 'gcc', 'g++', 'automake', 'libtool', 'python-numpy', 'python-nose', 'python-scipy', 'libopenblas-dev', 'git', 'docker-engine', 'linux-image-extra-virtual', "linux-image-extra-$kernelrelease", 'python3-pip', 'zlib1g-dev']:
  ensure => present,
